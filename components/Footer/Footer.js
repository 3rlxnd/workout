import { faBinoculars, faDumbbell, faLayerGroup, faRankingStar, faStopwatch } from "@fortawesome/free-solid-svg-icons";
...
export default function Footer() {
    ...
    return (
        <Container>
            <Navigation>
                {/* <Link href={'/'}><FontAwesomeIcon icon={faBinoculars} fontSize={25} color={router.route === '/' ? 'white' : '#5B5A60'}/></Link> */}
